const init = document.getElementById("form1")
const select = document.getElementById("option_choice")
...
init.addEventListener("click", function(e) {
	...
	const solutions = corrections[name]
	myQuizz = new Quizz(name,solutions)	
})